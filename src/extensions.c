...
ft_load (const char *file)
{
  ...
  sprintf (path_local, "%s/%s/%s", getenv ("HOME"), FT_LOCAL_EXT_DIR, file);
...
register_primitives ()
{
  ...
  scm_c_define_gsubr ("ft-connect-blocking", 0, 0, 0, ex_connect_blocking);
  ...
  scm_c_define_gsubr ("ft-subscription-deny", 1, 0, 0, ex_subscription_deny);
  ...
  scm_c_define_gsubr ("ft-get-current-buddy", 0, 0, 0, ex_get_current_buddy);
  scm_c_define_gsubr ("ft-set-current-buddy!", 1, 0, 0, ex_set_current_buddy);
  ...
  scm_c_define_gsubr ("ft-bind-to-ctrl-key", 2, 0, 0, ex_bind_to_ctrl_key);
